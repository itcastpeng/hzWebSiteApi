...
class SelectForm(forms.Form):
    ...
    def clean_task_list_id(self):
        task_list_id = self.data['task_list_id']
        objs = models.TaskList.objects.filter(id=task_list_id, is_delete=False)
        if objs:
            return task_list_id
        else:
            self.add_error('task_list_id', "任务id异常")
